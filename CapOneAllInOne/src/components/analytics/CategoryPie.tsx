...
const COLORS = ["#3b82f6","#ef4444","#10b981","#f59e0b","#8b5cf6","#14b8a6","#e11d48"];
    ...
    <div style={{ width: "100%", height: 320 }}>
      <ResponsiveContainer>
        <PieChart>
          ...
          <Legend />
          <Pie data={data} dataKey="amount" nameKey="category" innerRadius={60} outerRadius={100} paddingAngle={3}>
